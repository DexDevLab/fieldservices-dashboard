/*
  ...
  - Added the required column `tipoId` to the `TipoEquip` table without a default value. This is not possible if the table is not empty.
...
CREATE TABLE "new_TipoEquip" (
    ...
    CONSTRAINT "TipoEquip_tipoId_fkey" FOREIGN KEY ("tipoId") REFERENCES "Equipamentos" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
